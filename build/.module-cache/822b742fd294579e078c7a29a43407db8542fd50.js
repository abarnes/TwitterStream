        ...
        return (
            React.createElement("div", {id: "topbar"}, 
                React.createElement("form", null, 
                    ...
                    React.createElement("a", {href: "javascript:void(0);", onChange: this.handleStart, id: "stream-control", class: "standardbutton"}, "Start Stream"), 
...
var TweetStream = React.createClass({displayName: "TweetStream",
    ...
    handleStartStop: function() {
        ...
        oReq.onreadystatechange = function()
        {
            ...
            {
                this.setState({
                    tweets:oReq.responseText
                });
            }
        }
        oReq.open("POST", "../php/stream.php", true);
        oReq.setRequestHeader("Content-type","application/x-www-form-urlencoded");
        oReq.send("keywords="+encodeURIComponent(this.refs.filterTextInput.getDOMNode().value));
    },
    render: function() {
        return (
